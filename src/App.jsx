...
function App() {
  ...
  const copyPasswordToClipboard = useCallback(() => {
    ...
    // password jahan likha wo highlight krne k lye use below code
    passwordRef.current?.select();

    // kitne digit tk slect karna pass,use below code
...
rounded-lg overflow-hidden mb-4"'>
 ...
 className='    position: fixed     height: 40px;'>copy</button>
</div>
